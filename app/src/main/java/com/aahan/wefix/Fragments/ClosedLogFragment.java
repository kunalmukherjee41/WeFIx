...
public class ClosedLogFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_closed_log, container, false);
    }
...
//                        logsList.clear();
                        if (response.isSuccessful()) {
                            ...
                            for (Logs logs1 : logsList) {
                                if (logs1.getCallLogStatus().toUpperCase().equals("COMPLETE") || logs1.getCallLogStatus().toUpperCase().equals("CLOSE")) {
                                    logs.add(logs1);
                                }
                            }
