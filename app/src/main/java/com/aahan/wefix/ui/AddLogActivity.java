...
public class AddLogActivity extends AppCompatActivity {
    ...
    private EditText name, address1, zip_code, phone;
    private EditText email, city, company_name, problem_des;

    private LinearLayout layout;
    private Button next, addressChange, add, cancel;

    private String txt_address1, txt_name, txt_zip_code;
    private String txt_phone_number, txt_company_name;
